...
class SettingsProvider extends ChangeNotifier {
  ...
  String get coachPersona {
    final stored =
        _preferencesBox.get('coach_persona', defaultValue: 'coach_neutre');
  ...
  Future<void> updateDefaultCaliber(String? value) async {
    await PreferencesService().setDefaultCaliber(value);
    notifyListeners();
  }
  ...
  Future<void> importFromJson(
      String path, Function(String) onSuccess, Function(String) onError) async {
    try {
