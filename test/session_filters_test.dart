...
void main() {
  ...
  group('SessionFilters.byExercise', () {
    ...
    test('ne garde que les sessions liées à l\'exercice donné', () {
      final s1 = makeSession(id: 1, exerciseId: 'ex-a');
      final s2 = makeSession(id: 2, exerciseId: 'ex-b');
      final s3 = makeSession(id: 3, exerciseId: 'ex-a');
    ...
    test('est combinable avec un filtre de statut (réalisées + exercice)', () {
      final realizedWithEx = makeSession(id: 1, exerciseId: 'ex-a');
      final plannedWithEx = makeSession(
          id: 2,
          exerciseId: 'ex-a',
          status: SessionConstants.statusPrevue);
      final realizedWithoutEx = makeSession(id: 3, exerciseId: 'ex-b');

      final byExercise = SessionFilters.byExercise(
          [realizedWithEx, plannedWithEx, realizedWithoutEx], 'ex-a');
