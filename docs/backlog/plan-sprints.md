...
| 6 | NT-104 | Restitution immédiate de la progression par discipline. | NT-100, NT-010 | app |
| 7 | NT-120, NT-121 | Donne un vrai écran Coach transverse, à forte valeur métier. | NT-101, NT-010, NT-030 | both |
| 8 | NT-122 | Socle serveur pour que le coach produise des entités validables. | NT-031 | server |
| 9 | NT-123, NT-124 | Le coach devient actionnable : exercices et objectifs proposés, validés par le tireur. | NT-122, NT-020, NT-012 | both |
| 10 | NT-102, NT-074 | Usage terrain avancé restant après livraison prioritaire de NT-131 : match blanc et optimisations génériques de saisie. | NT-101, NT-002 | app |
| 11 | NT-134 | Lecture graphique score/groupement au fil d'une séance, après validation du récapitulatif NT-131. | NT-131, NT-011 | app |
| 12 | NT-111 | Analyse qualitative photo par IA, utile mais seulement après photos taguées et référentiel. | NT-005, NT-110, NT-100, NT-030 | both |
...
des sauvegardes ni les parcours métier existants.

| Ordre | Item | Livrable principal | Dépendances ou garde-fous |
|---|---|---|---|
| 1 | NT-150 | État Auth unique et cohérent, migration des jetons v0.6.0 et écran « Connexion à vérifier » au premier démarrage hors ligne sans profil en cache. | Après NT-056 ; préserver les jetons lors des erreurs transitoires et ne modifier aucun contrat serveur. |
| 2 | NT-145 | Ouvrir depuis chaque carte de record la session source, avec départage déterministe des ex æquo. | Ne modifier ni le calcul ni l'apparence permanente des cartes. |
| 3 | NT-146 | Aide gestuelle partagée pour estimer un groupement en séance guidée et dans le wizard. | Gestes seulement ; aucune valeur injectée dans le formulaire. |
| 4 | NT-147 | Ordonner calibres, catégories puis tirs par arme en bas de Synthèse. | Après NT-142 ; déplacement de présentation uniquement. |
...
groupement disponible dans les deux saisies, ordre de Synthèse et séparateurs
conformes, et noms d'export rebrandés sans rupture d'import.
